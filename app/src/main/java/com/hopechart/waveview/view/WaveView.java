package com.hopechart.waveview.view;
...
public class WaveView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (iterator.hasNext()) {
            ...
            if (System.currentTimeMillis() - circle.mCreateTime < mDuration) {
                ...
                canvas.drawCircle((float) (getWidth() / 2 + radius * Math.cos(Math.PI * circle.angle / 180.0)),
                        (float) (getWidth() / 2 + radius * Math.sin(Math.PI * circle.angle / 180.0)),
                        circle.radioDot, mPaint);
            } else {
                iterator.remove();
            }
        }
    ...
    private class Circle {
        ...
        int getAlpha() {
            ...
            return (int) (235 - mInterpolator.getInterpolation(percent) * 235);
        }
